...
export const Dashboard = ({ onLogout }: DashboardProps) => {
  ...
  // Users list intentionally omitted from UI for now; keep logic simple
  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-1 container-fluid section">
        <div className="space-y-8">
          ...
          <section className="fade-in">
            <div className="mb-6">
              <h2 className="text-display text-2xl sm:text-3xl text-gradient mb-2">
                Accesos directos
              </h2>
            ...
            <div className="grid-responsive">
              <QuickAccessCard
                ...
                onClick={() => showToast.success("Función en desarrollo")}
              />
              ...
              <QuickAccessCard
                ...
                description="Obtén ayuda con el sistema"
                onClick={() => showToast.success("Función en desarrollo")}
              />
            </div>
          </section>
