...
class Database:
    def __init__(self):
        ...
        if create_client is None:
            print("Supabase client not available; using mock database client")
            self.client = None
            return
    ...
    def create_profile(self, profile_data: ProfileCreate) -> Optional[Profile]:
        ...
        if not self.client:
            ...
            return Profile(
                ...
                username=getattr(profile_data, "username", "testuser"),
                created_at="2024-01-01T00:00:00Z",
                updated_at="2024-01-01T00:00:00Z",
            )
    ...
    def update_project(
        ...
        if not self.client:
            ...
            # Return a Project shaped like an update result. Keep values from
            # provided data and sensible defaults for missing fields.
            return Project(
                id=project_id,
